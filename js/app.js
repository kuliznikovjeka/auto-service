(() => {
    ...
    da.init();
    const controls = document.querySelectorAll("[data-accordion-control]");
    controls.forEach((control => {
        const item = control.parentNode;
        const content = control.nextElementSibling;
        control.addEventListener("click", (() => {
            item.classList.toggle("open");
            if (item.classList.contains("open")) content.style.maxHeight = content.scrollHeight + "px"; else content.style.maxHeight = null;
        }));
    }));
    window["FLS"] = true;
    isWebp();
